export enum CollectionColors {
    ...
    Night = "bg-gradient-to-r from-purple-400 to-pink-500",
    ...
    Lavender = "bg-gradient-to-r from-purple-400 to-fuchsia-500",
    ...
    Sea = "bg-gradient-to-r from-cyan-400 to-teal-500",
    ...
    Mauve = "bg-gradient-to-r from-purple-400 to-fuchsia-500",
    Sand = "bg-gradient-to-r from-yellow-400 to-orange-500",
    Mint = "bg-gradient-to-r from-green-400 to-teal-500",
    Berry = "bg-gradient-to-r from-purple-400 to-fuchsia-500",  
}
